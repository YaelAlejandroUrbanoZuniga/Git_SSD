...
one notification per **SSD** user. This is a provisional audience decision (whole SSD team)
until the RASIC matrix defines finer per-role/per-commodity audiences. Every call site wraps
