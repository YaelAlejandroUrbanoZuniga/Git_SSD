...
export const completedSuppliers: CompletedSupplier[] = [
  {
    id: 'ps14', folio: 'SSD-2026-014', name: 'DENSO', stage: 'Completed', scoutingPhase: null, entrySource: 'Recommendation',
    ...
    b2bStatus: 'Yes', b2bWhoAttends: 'Yuki Tanaka, Global Sales Director', b2bManager: 'Ana García', b2bBuyer: 'Ana García', b2bComments: 'Reviewed ASIL-D controller capability and dual-source allocation strategy',
    agendaStatus: 'Confirmed', agendaTeamsLink: 'https://teams.microsoft.com/l/meetup-join/denso2026',
    ...
    parkingIsRecommendation: true, parkingBuyer: 'Ana García', parkingCompanyName: 'DENSO', parkingB2BMeeting: 'Yes',
    parkingName1: 'Yuki Tanaka', parkingWebsite: 'https://denso.com', parkingEmail1: 'global.sales@denso.com', parkingPhone: '+81 566 25 5511',
    ...
    preliminaryTabsCompleted: { overview: true, capabilities: true, visit: true },
    supplierEvalTabsCompleted: { competitiveness: true, fundamentals: true },
    prelim_startDate: '2026-01-15', prelim_priority: 1, prelim_scoutingInput: 'Registro directo', prelim_buyer: 'Ana García', prelim_commodity: 'Electronics MSB', prelim_primaryDriver: 'Dual Source',
    prelim_companyName: 'DENSO Corporation', prelim_dunsNumber: '69-456-7890', prelim_hqAddress: 'DENSO HQ, 1-1 Showa-cho', prelim_hqCity: 'Kariya', prelim_hqCountry: 'Japan',
    ...
    prelim_mainTechnology: 'Power Electronics', prelim_pressCapacity: 'N/A', prelim_generalManager: 'Yuki Tanaka', prelim_market: 'Automotive', prelim_topCustomers: 'Toyota, Honda, Subaru', prelim_exportCapability: 'Yes',
    ...
    prelim_visitDatePlanned: '2026-02-10', prelim_visitDateCompleted: '2026-02-10', prelim_visitParticipants: 'Yuki Tanaka (DENSO), Ana García (Nexteer)', prelim_strengths: 'Tier-1 electronics leader, Toyota Production System, ASIL-D', prelim_weaknesses: 'Toyota-first allocation policy', prelim_observations: 'Intelex Handoff created, development initiated', prelim_recommendations: 'Track milestone deliverables',
    prelim_parts: [
    ...
    prelim_noteworthyNotes: 'Full preliminary evaluation complete. All legal documents signed. Approved for supplier evaluation and Intelex handoff.',
  ...
  {
    id: 'ps15', folio: 'SSD-2026-015', name: 'AISIN', stage: 'Completed', scoutingPhase: null, entrySource: 'Scouting Event',
    ...
    onboardingDate: '2025-11-01',
    scoutingTabsCompleted: { scoutingEvent: true, supplierInfo: true, attendees: true, agenda: true, nextStep: true },
    b2bStatus: 'Yes', b2bWhoAttends: 'Hiroshi Sato, Sales Director', b2bManager: 'Carlos Mendoza', b2bBuyer: 'Carlos Mendoza', b2bComments: 'Discussed EPS pump localization and sample timeline for MY2028 truck program',
    agendaStatus: 'Confirmed', agendaTeamsLink: 'https://teams.microsoft.com/l/meetup-join/aisin2026',
    ...
    selectedForParking: true, selectionReason: 'Toyota Group EPS pump specialist approved for full evaluation',
    parkingOnboardingDate: '2025-12-20', parkingTimeless: false, parkingDateToMovePreliminary: '2026-02-01',
    parkingDaysElapsed: 43, parkingScoutingInput: 'Scouting B2B Sessions Q2', parkingSubStatus: 'Go',
    parkingIsRecommendation: false, parkingBuyer: 'Carlos Mendoza', parkingCompanyName: 'AISIN', parkingB2BMeeting: 'Yes',
    parkingName1: 'Hiroshi Sato', parkingWebsite: 'https://aisin.com', parkingEmail1: 'sales@aisin.com', parkingPhone: '+81 566 24 8441',
    ...
    preliminaryTabsCompleted: { overview: true, capabilities: true, visit: true },
    supplierEvalTabsCompleted: { competitiveness: true, fundamentals: true },
    prelim_startDate: '2026-02-01', prelim_priority: 2, prelim_scoutingInput: 'Scouting B2B Sessions Q2', prelim_buyer: 'Carlos Mendoza', prelim_commodity: 'Machining', prelim_primaryDriver: 'Dual Source',
    prelim_companyName: 'Aisin Corporation', prelim_dunsNumber: '69-234-5678', prelim_hqAddress: 'Aisin HQ, 2-1 Asahi-machi', prelim_hqCity: 'Kariya', prelim_hqCountry: 'Japan',
    prelim_manufacturingAddress: 'Kariya Plant', prelim_manufacturingCity: 'Kariya', prelim_manufacturingCountry: 'Japan', prelim_companyType: 'Public', prelim_foundedYear: 1949,
    ...
    prelim_mainTechnology: 'Hydraulic Pump Manufacturing', prelim_pressCapacity: '1500T', prelim_generalManager: 'Hiroshi Sato', prelim_market: 'Automotive', prelim_topCustomers: 'Toyota, Honda, Stellantis', prelim_exportCapability: 'Yes',
    ...
    prelim_visitDatePlanned: '2026-03-05', prelim_visitDateCompleted: '2026-03-05', prelim_visitParticipants: 'Hiroshi Sato (Aisin), Carlos Mendoza (Nexteer)', prelim_strengths: 'EPS pump expertise, Toyota Group supplier', prelim_weaknesses: 'Premium pricing', prelim_observations: 'Development initiated, first samples expected Q4 2026', prelim_recommendations: 'Monitor sample delivery',
    prelim_parts: [
    ...
    intelex_notes: 'Development completed. Supplier approved through full SSD cycle.',
    completedDate: '2026-06-15',
    completedBy: 'Carlos Mendoza',
  },
];
